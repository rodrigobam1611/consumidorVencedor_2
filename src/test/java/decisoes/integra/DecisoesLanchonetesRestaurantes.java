...
public class DecisoesLanchonetesRestaurantes {

	static WebElement element = null;
	static WebDriver driver;
	
	public DecisoesLanchonetesRestaurantes(WebDriver driver){
	
		this.driver = driver;
	}
	
	public void acessarSecaoLanchonetesRestaurantes() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Lanchonetes e Restaurantes")
	public void acessarIntegraDecisoesAlimentacaoBebidas() throws InterruptedException, IOException{
	   ...
	   try{
		   ...
		   attachTotalArqErros(totalArquivosErro.toString());
    ...
    public static String attachTotalArqErros(String url){
