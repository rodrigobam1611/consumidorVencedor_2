...
public class DecisoesSupermercadosMercearias {

	static WebElement element = null;
	static WebDriver driver;
	
	public DecisoesSupermercadosMercearias(WebDriver driver) {
	
		this.driver = driver;
	}
	
public void acessarSecaoSupermercadoMercearias() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Supermercados e Mercearias")
