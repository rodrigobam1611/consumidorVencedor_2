...
public class DecisoesPapelariasLivros {
	...
	public DecisoesPapelariasLivros(WebDriver driver) {
...
public void acessarSecaoPapelariasLivros() throws InterruptedException{
		
		driver.navigate().to("http://rj.consumidorvencedor.mp.br/vitorias");
		
		element = driver.findElement(By.xpath("//div[@class='home-vitorias']/div[@class='box-produtos box-vitorias-home']"));
		element.click();
		
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[6]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Papelaria e Livros")
	public void acessarDecisoesIntegraPapelariasLivros() throws InterruptedException, IOException{
