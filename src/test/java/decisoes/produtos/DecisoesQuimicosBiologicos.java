...
public class DecisoesQuimicosBiologicos {
	...
	public DecisoesQuimicosBiologicos(WebDriver driver) {
	...
	public void acessarSecaoQuimicosBio() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[7]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Químicos e Biológicos")
	public void acessarDecisoesIntegraQuimicosBio() throws InterruptedException, IOException{
