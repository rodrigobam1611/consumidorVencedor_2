...
public class DecisoesVeiculos {
	...
	public DecisoesVeiculos(WebDriver driver) {
	...
	public void acessarSecaoVeiculos() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[8]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Veículos")
	public void acessarDecisoesIntegraVeiculos() throws InterruptedException, IOException{
