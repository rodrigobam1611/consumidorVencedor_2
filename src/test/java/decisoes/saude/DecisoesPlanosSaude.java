...
public class DecisoesPlanosSaude {
	...
	public DecisoesPlanosSaude(WebDriver driver) {
	...
	public void acessarSecaoPlanosSaude() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[4]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Planos de Saúde")
	public void acessarDecisoesIntegraPlanosSaude() throws InterruptedException, IOException{
