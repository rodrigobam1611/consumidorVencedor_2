...
public class DecisoesProfissionaisLiberais {
	...
	public DecisoesProfissionaisLiberais(WebDriver driver) {
	...
	public void acessarSecaoProfissionaisLiberais() throws InterruptedException{
		
		driver.navigate().to("http://rj.consumidorvencedor.mp.br/vitorias");
		
		element = driver.findElement(By.xpath("//div[@class='home-vitorias']/div[@class='box-saude box-vitorias-home']"));
		element.click();
		
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[5]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Profissionais Liberais")
	public void acessarDecisoesIntegraProfissionaisLiberais() throws InterruptedException, IOException{
