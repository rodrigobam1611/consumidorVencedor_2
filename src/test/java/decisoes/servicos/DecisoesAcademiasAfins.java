...
public class DecisoesAcademiasAfins {
	...
	public DecisoesAcademiasAfins(WebDriver driver) {
	...
	public void acessarSecaoAcademiasAfins() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Academias e afins")
	public void acessarDecisoesIntegraAcademiasAfins() throws InterruptedException, IOException{
