...
public class DecisoesAgua {
	...
	public DecisoesAgua(WebDriver driver) {
	...
	public void acessarSecaoAgua() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[13]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Água")
	public void acessarDecisoesIntegraAgua() throws InterruptedException, IOException{
