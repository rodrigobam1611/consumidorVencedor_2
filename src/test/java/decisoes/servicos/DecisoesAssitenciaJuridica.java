...
public class DecisoesAssitenciaJuridica {
	...
	public DecisoesAssitenciaJuridica(WebDriver driver) {
	...
	public void acessarSecaoAssistenciaJuridica() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[2]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Assistência Jurídica")
	public void acessarDecisoesIntegraAssistenciaJuridica() throws InterruptedException, IOException{
