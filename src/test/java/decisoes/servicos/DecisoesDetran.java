...
public class DecisoesDetran {
	...
	public DecisoesDetran(WebDriver driver) {
	...
	public void acessarSecaoDetran() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Detran")
	public void acessarDecisoesIntegraDetran() throws InterruptedException, IOException{
