...
public class DecisoesGas {
	...
	public DecisoesGas(WebDriver driver) {
	...
	public void acessarSecaoGas() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Gás")
	public void acessarDecisoesIntegraGas() throws InterruptedException, IOException{
