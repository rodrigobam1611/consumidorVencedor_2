...
public class DecisoesLuz {
	...
	public DecisoesLuz(WebDriver driver) {
	...
	public void acessarSecaoLuz() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Luz")
	public void acessarDecisoesIntegraLuz() throws InterruptedException, IOException{
