...
public class DecisoesPostal {
	...
	public DecisoesPostal(WebDriver driver) {
	...
	public void acessarSecaoPostal() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[9]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Postal")
	public void acessarDecisoesIntegraPostal() throws InterruptedException, IOException{
