...
public class DecisoesProconVigSanitaria {
	...
	public DecisoesProconVigSanitaria(WebDriver driver) {
	...
	public void acessarSecaoProconVigSanitaria() throws InterruptedException{
		
		driver.navigate().to("http://rj.consumidorvencedor.mp.br/vitorias");
		
		element = driver.findElement(By.xpath("//div[@class='home-vitorias']/div[@class='box-servicos box-vitorias-home']"));
		element.click();
		
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[10]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Procons e Vigilância Sanitária (Criação e Estruturação)")
	public void acessarDecisoesIntegraProconVigSanitaria() throws InterruptedException, IOException{
