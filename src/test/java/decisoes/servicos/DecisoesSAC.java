...
public class DecisoesSAC {
	...
	public DecisoesSAC(WebDriver driver) {
	...
	public void acessarSecaoSAC() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[11]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - SAC")
	public void acessarDecisoesIntegraSAC() throws InterruptedException, IOException{
