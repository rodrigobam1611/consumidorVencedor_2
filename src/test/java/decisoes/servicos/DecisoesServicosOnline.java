...
public class DecisoesServicosOnline {
	...
	public DecisoesServicosOnline(WebDriver driver) {
	...
	public void acessarSecaoServicosOnline() throws InterruptedException{
		...
		element = driver.findElement(By.xpath("//ul[@class='lista-quadrado']/li[12]/a"));
		element.click();
	}
	
	@Step("Acesso às Decisões na Ìntegra - Serviços On-line(E-mails, Aplicativos, Redes Sociais, Hospedagem, etc.)")
	public void acessarDecisoesIntegraServicosOnline() throws InterruptedException, IOException{
