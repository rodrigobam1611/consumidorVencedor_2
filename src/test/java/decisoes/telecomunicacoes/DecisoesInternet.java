...
public class DecisoesInternet {
	...
	public DecisoesInternet(WebDriver driver) {
	...
	public void acessarSecaoInternet() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Internet (Conexão)")
	public void acessarDecisoesIntegraInternet() throws InterruptedException, IOException{
