...
public class DecisoesTVAssinatura {
	...
	public DecisoesTVAssinatura(WebDriver driver) {
	...
	public void acessarSecaoTVAssinatura() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - TV por Assinatura")
	public void acessarDecisoesIntegraTVAssinatura() throws InterruptedException, IOException{
