...
public class DecisoesAereo {
	...
	public DecisoesAereo(WebDriver driver) {
	...
	public void acessarSecaoAereo() throws InterruptedException{
	...
	@Step("Acesso às Decisões na Ìntegra - Aéreo")
	public void acessarDecisoesIntegraAereo() throws InterruptedException, IOException{
