...
public class DecisoesBarcas {
	...
	public DecisoesBarcas(WebDriver driver) {
	...
	public void acessarSecaoBarcas() throws InterruptedException{
		
		driver.navigate().to("http://rj.consumidorvencedor.mp.br/vitorias");
		
		element = driver.findElement(By.xpath("//div[@class='home-vitorias']/div[@class='box-transporte box-vitorias-home']"));
		element.click();
	...
	@Step("Acesso às Decisões na Ìntegra - Barcas")
	public void acessarDecisoesIntegraBarcas() throws InterruptedException, IOException{
