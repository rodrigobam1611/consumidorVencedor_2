...
import decisoes.transporte.TodasDecisoesTransporte;
import ru.yandex.qatools.allure.annotations.Attachment;
import ru.yandex.qatools.ashot.AShot;
import ru.yandex.qatools.ashot.shooting.ShootingStrategies;

public class ConsumidorVencedorTransportePOM{
	...
	public ConsumidorVencedorTransportePOM(WebDriver driver) {
...
//		driver.navigate().to(BASE_URL_RJ);
	...
	public void acessarDecisoesAereo() throws InterruptedException, IOException{
		
		TodasDecisoesTransporte aereo = new TodasDecisoesTransporte(driver);
		aereo.decisoesIntegraAereo();
	}
	
	public void acessarDecisoesBarcas() throws InterruptedException, IOException{
		
		TodasDecisoesTransporte barcas = new TodasDecisoesTransporte(driver);
		barcas.decisoesIntegraBarcas();
	}
